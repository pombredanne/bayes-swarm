...
class MMResultSearch(object):
    def __init__(self, box, searchform):
        ...
        column_pct.set_min_width(25)
        column_pct.set_fixed_width(50)
        column_pct.set_resizable(True)
        column_pct.set_expand(False)
        ...
        column_name.set_fixed_width(500)
        ...
        column_date.set_min_width(25)
        column_date.set_fixed_width(50)
        column_date.set_resizable(True)
        column_date.set_expand(False)
