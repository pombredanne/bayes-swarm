...
\slide{Il processo di estrazione}
Il processo di estrazione comprende diverse fasi:
\begin{center}
...
\slide{Il processo di estrazione (continua)}
Il processo di estrazione utilzza un sistema modulare facilmente estendibile con un minimo di conoscenze necessarie, basato sul concetto di ETL (Extact, Transform and Load) tipico dei datawarehouse
\begin{center}
...
\begin{center}
  \includegraphics{./figures/graph_compression.png}
\end{center}
